...
public class SerialVersionUIDAdder extends ClassVisitor {
   ...
   // $FF: synthetic field
   static Class class$org$objectweb$asm$commons$SerialVersionUIDAdder = class$("set.hyrts.org.objectweb.asm.commons.SerialVersionUIDAdder");
   ...
   protected long computeSVUID() throws IOException {
      ...
      try {
         ...
         var2.flush();
         byte[] var11 = this.computeSHAdigest(var1.toByteArray());

         for(int var7 = Math.min(var11.length, 8) - 1; var7 >= 0; --var7) {
            var3 = var3 << 8 | (long)(var11[var7] & 255);
         }
      } finally {
         if (var2 != null) {
            var2.close();
