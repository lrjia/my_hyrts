...
public class ASMifier extends Printer {
   ...
   // $FF: synthetic field
   static Class class$org$objectweb$asm$util$ASMifier = class$("set.hyrts.org.objectweb.asm.util.ASMifier");
   ...
   public void visit(int var1, int var2, String var3, String var4, String var5, String[] var6) {
      ...
      if (var3 == null) {
         ...
         if (var8 == -1) {
            ...
            var7 = var3.substring(var8 + 1).replace('-', '_');
         }
      }
   ...
   public Printer visitModule(String var1, int var2, String var3) {
      ...
      this.appendConstant(var1);
      this.buf.append(", ");
      this.appendAccess(var2 | 2097152);
      this.buf.append(", ");
      this.appendConstant(var3);
      this.buf.append(");\n\n");
      this.text.add(this.buf.toString());
      ASMifier var4 = this.createASMifier("mdv", 0);
   ...
   protected ASMifier createASMifier(String var1, int var2) {
      return new ASMifier(393216, var1, var2);
   }
   ...
   static void appendConstant(StringBuffer var0, Object var1) {
      if (var1 == null) {
         ...
         var0.append(var2.isInterface()).append(")");
