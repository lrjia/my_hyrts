...
class Frame {
   ...
   final boolean a(ClassWriter var1, Frame var2, int var3) {
      boolean var4 = false;
      int var10 = this.c.length;
      int var11 = this.d.length;
      if (var2.c == null) {
         var2.c = new int[var10];
         var4 = true;
      }
      ...
      for(var5 = 0; var5 < var10; ++var5) {
         if (this.e != null && var5 < this.e.length) {
            var6 = this.e[var5];
            if (var6 == 0) {
               var9 = this.c[var5];
            } else {
               ...
               if (var8 == 16777216) {
                  ...
                  if (var8 == 33554432) {
                     var9 = var7 + this.c[var6 & 8388607];
                  } else {
                     var9 = var7 + this.d[var11 - (var6 & 8388607)];
                  }
      ...
      if (var3 > 0) {
         ...
         for(var5 = 0; var5 < this.g; ++var5) {
            ...
            var4 |= a(var1, var9, var2.d, var12 + var5);
         }
