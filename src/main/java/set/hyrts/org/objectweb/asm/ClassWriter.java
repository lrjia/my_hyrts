...
public class ClassWriter extends ClassVisitor {
   ...
   public final ModuleVisitor visitModule(String var1, int var2, String var3) {
      return this.L = new ModuleWriter(this, this.newModule(var1), var2, var3 == null ? 0 : this.newUTF8(var3));
   }
   ...
   public byte[] toByteArray() {
      if (this.c > 65535) {
         ...
         if (this.L != null) {
            var7.putShort(this.newUTF8("Module"));
            this.L.b(var7);
            this.L.a(var7);
         }
         ...
         if (this.J) {
            ...
            this.F = var10 ? 1 : 0;
            this.J = false;
            (new ClassReader(var7.a)).accept(this, (var10 ? 8 : 0) | 256);
   ...
   Item a(Object var1) {
      ...
      if (var1 instanceof Integer) {
         ...
         return this.a(8, (String)var1);
      } else if (var1 instanceof Type) {
         Type var4 = (Type)var1;
         int var3 = var4.getSort();
         if (var3 == 10) {
            return this.a(7, var4.getInternalName());
         } else {
            return var3 == 11 ? this.a(16, var4.getDescriptor()) : this.a(7, var4.getDescriptor());
         }
   ...
   Item a(int var1, String var2) {
      this.h.a(var1, var2, (String)null, (String)null);
      Item var3 = this.a(this.h);
      if (var3 == null) {
         this.d.b(var1, this.newUTF8(var2));
   ...
   static {
      _clinit_();
      byte[] var1 = new byte[221];
      String var2 = "AAAAAAAAAAAAAAAABCLMMDDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAADDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAANAAAAAAAAAAAAAAAAAAAAJJJJJJJJJJJJJJJJDOPAAAAAAGGGGGGGHIFBFAAFFAARQJJKKSSSSSSSSSSSSSSSSSST";
