...
import set.hyrts.org.objectweb.asm.signature.SignatureVisitor;
import set.hyrts.org.objectweb.asm.signature.SignatureWriter;
...
public abstract class Remapper {
   ...
   public String mapPackageName(String var1) {
      String var2 = this.map(var1 + ".FakeClassName");
      int var3;
      return var2 != null && (var3 = var2.lastIndexOf(46)) != -1 ? var2.substring(0, var3) : var1;
   }
