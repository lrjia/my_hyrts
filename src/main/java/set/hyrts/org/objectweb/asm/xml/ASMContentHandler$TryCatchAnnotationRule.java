...
final class ASMContentHandler$TryCatchAnnotationRule extends ASMContentHandler$Rule {
   ...
   ASMContentHandler$TryCatchAnnotationRule(ASMContentHandler var1) {
      super(var1);
      this.this$0 = var1;
   }
   ...
   public void begin(String var1, Attributes var2) {
      ...
      this.this$0.push(((MethodVisitor)this.this$0.peek()).visitTryCatchAnnotation(var5, var6, var3, var4));
   }
