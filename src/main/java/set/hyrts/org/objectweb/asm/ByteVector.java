...
public class ByteVector {
   ...
   ByteVector c(String var1, int var2, int var3) {
      ...
      if (var5 > var3) {
         ...
         var7 = this.b - var2 - 2;
         if (var7 >= 0) {
            this.a[var7] = (byte)(var5 >>> 8);
            this.a[var7 + 1] = (byte)var5;
         }
         ...
         for(int var9 = var2; var9 < var4; ++var9) {
            ...
            if (var6 >= 1 && var6 <= 127) {
               this.a[var8++] = (byte)var6;
            } else if (var6 > 2047) {
               this.a[var8++] = (byte)(224 | var6 >> 12 & 15);
               this.a[var8++] = (byte)(128 | var6 >> 6 & 63);
               this.a[var8++] = (byte)(128 | var6 & 63);
            } else {
               this.a[var8++] = (byte)(192 | var6 >> 6 & 31);
               this.a[var8++] = (byte)(128 | var6 & 63);
            }
         }
