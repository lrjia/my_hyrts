...
public class CheckMethodAdapter extends MethodVisitor {
   ...
   private static void _clinit_() {
      class$org$objectweb$asm$util$CheckMethodAdapter = class$("set.hyrts.org.objectweb.asm.util.CheckMethodAdapter");
      class$org$objectweb$asm$Label = class$("set.hyrts.org.objectweb.asm.Label");
   }
}
