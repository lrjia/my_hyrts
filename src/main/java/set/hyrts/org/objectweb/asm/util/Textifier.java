...
import set.hyrts.org.objectweb.asm.TypeReference;
import set.hyrts.org.objectweb.asm.signature.SignatureReader;
...
public class Textifier extends Printer {
   ...
   // $FF: synthetic field
   static Class class$org$objectweb$asm$util$Textifier = class$("set.hyrts.org.objectweb.asm.util.Textifier");
   ...
   public Printer visitModule(String var1, int var2, String var3) {
      ...
      this.buf.append("module ").append(var1).append(" { ").append(var3 == null ? "" : "// " + var3).append("\n\n");
      this.text.add(this.buf.toString());
   ...
   public void visitMainClass(String var1) {
      this.buf.setLength(0);
      this.buf.append("  // main class ").append(var1).append('\n');
      this.text.add(this.buf.toString());
   }

   public void visitPackage(String var1) {
      this.buf.setLength(0);
      this.buf.append("  // package ").append(var1).append('\n');
      this.text.add(this.buf.toString());
   }
   ...
   public void visitRequire(String var1, int var2, String var3) {
      ...
      this.buf.append(var1).append(";  // access flags 0x").append(Integer.toHexString(var2).toUpperCase()).append('\n');
      if (var3 != null) {
         this.buf.append("  // version ").append(var3).append('\n');
      }
   ...
   public void visitExport(String var1, int var2, String... var3) {
      ...
      if (var3 != null && var3.length > 0) {
         for(int var4 = 0; var4 < var3.length; ++var4) {
            this.buf.append(this.tab2).append(var3[var4]);
            this.buf.append(var4 != var3.length - 1 ? ",\n" : ";\n");
         }
      }
   ...
   public void visitProvide(String var1, String... var2) {
      ...
      for(int var3 = 0; var3 < var2.length; ++var3) {
         ...
         this.buf.append(var3 != var2.length - 1 ? ",\n" : ";\n");
      }
