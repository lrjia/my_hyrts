...
public class ASMContentHandler extends DefaultHandler implements Opcodes {
   ...
   private static void addOpcode(String var0, int var1, int var2) {
      OPCODES.put(var0, new ASMContentHandler$Opcode(var1, var2));
   }

   public ASMContentHandler(ClassVisitor var1) {
      ...
      ASMContentHandler$ModuleRule var2 = new ASMContentHandler$ModuleRule(this);
      this.RULES.add("class/module", var2);
      this.RULES.add("class/module/main-class", var2);
      this.RULES.add("class/module/target", var2);
      this.RULES.add("class/module/packages", var2);
      this.RULES.add("class/module/requires", var2);
      this.RULES.add("class/module/exports", var2);
      this.RULES.add("class/module/exports/to", var2);
      this.RULES.add("class/module/uses", var2);
      this.RULES.add("class/module/provides", var2);
   ...
   public final void startElement(String var1, String var2, String var3, Attributes var4) throws SAXException {
      String var5 = var2 != null && var2.length() != 0 ? var2 : var3;
      StringBuffer var6 = new StringBuffer(this.match);
      if (this.match.length() > 0) {
         var6.append('/');
      }

      var6.append(var5);
      this.match = var6.toString();
      ASMContentHandler$Rule var7 = (ASMContentHandler$Rule)this.RULES.match(this.match);
      if (var7 != null) {
         var7.begin(var5, var4);
      }

   }

   public final void endElement(String var1, String var2, String var3) throws SAXException {
      String var4 = var2 != null && var2.length() != 0 ? var2 : var3;
      ASMContentHandler$Rule var5 = (ASMContentHandler$Rule)this.RULES.match(this.match);
      if (var5 != null) {
         var5.end(var4);
      }

      int var6 = this.match.lastIndexOf(47);
      if (var6 >= 0) {
         this.match = this.match.substring(0, var6);
      } else {
         this.match = "";
      }
   ...
   final Object peek() {
      ...
      return var1 == 0 ? null : this.stack.get(var1 - 1);
   }

   final Object pop() {
      int var1 = this.stack.size();
      return var1 == 0 ? null : this.stack.remove(var1 - 1);
   }

   final void push(Object var1) {
      this.stack.add(var1);
   }
   ...
   static {
      ...
      TYPES = new HashMap();
      String[] var0 = SAXCodeAdapter.TYPES;

      for(int var1 = 0; var1 < var0.length; ++var1) {
         TYPES.put(var0[var1], new Integer(var1));
      }
