...
import set.hyrts.org.objectweb.asm.tree.analysis.Analyzer;
import set.hyrts.org.objectweb.asm.tree.analysis.BasicValue;
import set.hyrts.org.objectweb.asm.tree.analysis.Frame;
import set.hyrts.org.objectweb.asm.tree.analysis.SimpleVerifier;
...
public class CheckClassAdapter extends ClassVisitor {
   ...
   // $FF: synthetic field
   static Class class$org$objectweb$asm$util$CheckClassAdapter = class$("set.hyrts.org.objectweb.asm.util.CheckClassAdapter");
   ...
   public void visit(int var1, int var2, String var3, String var4, String var5, String[] var6) {
      if (this.start) {
         ...
         this.start = true;
         this.checkState();
         checkAccess(var2, 456241);
         if (var3 == null) {
            throw new IllegalArgumentException("Illegal class name (null)");
         } else {
            if (!var3.endsWith("package-info")) {
   ...
   public ModuleVisitor visitModule(String var1, int var2, String var3) {
      ...
      if (this.module) {
         ...
         if (var1 == null) {
            ...
            checkAccess(var2, 4128);
            return new CheckModuleAdapter(super.visitModule(var1, var2, var3), (var2 | 32) != 0);
         }
      }
   }
