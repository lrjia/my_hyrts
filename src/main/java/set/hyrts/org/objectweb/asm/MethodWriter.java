...
class MethodWriter extends MethodVisitor {
      ...
      if (this.O != null) {
         if (this.L != 0 && this.L != 1) {
            ...
            label77: {
               ...
               switch(var1) {
               case 178:
                  var6 = this.P + (var7 != 'D' && var7 != 'J' ? 1 : 2);
                  break label77;
               case 179:
                  var6 = this.P + (var7 != 'D' && var7 != 'J' ? -1 : -2);
                  break label77;
               case 180:
                  var6 = this.P + (var7 != 'D' && var7 != 'J' ? 0 : 1);
                  break label77;
               }

               var6 = this.P + (var7 != 'D' && var7 != 'J' ? -2 : -3);
            }
   ...
   private void b(Frame var1) {
      ...
      int var9 = this.a(var1.b.c, var5, var6);
