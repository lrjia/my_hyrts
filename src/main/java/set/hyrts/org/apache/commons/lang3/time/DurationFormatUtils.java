package set.hyrts.org.apache.commons.lang3.time;
...
public class DurationFormatUtils {
   ...
   static String format(DurationFormatUtils.Token[] tokens, long years, long months, long days, long hours, long minutes, long seconds, long milliseconds, boolean padWithZeros) {
      ...
      DurationFormatUtils.Token[] var18 = tokens;
      int var19 = tokens.length;

      for(int var20 = 0; var20 < var19; ++var20) {
         DurationFormatUtils.Token token = var18[var20];
   ...
   static class Token {
      ...
      static boolean containsTokenWithValue(DurationFormatUtils.Token[] tokens, Object value) {
         DurationFormatUtils.Token[] var2 = tokens;
         int var3 = tokens.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            DurationFormatUtils.Token token = var2[var4];
